        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="deleteForm" action="code.php" method="POST">
                    ...
                    <button type="submit" name="delete_out_of_stock_btn" class="btn btn-danger"
    ...
    <div class="card shadow nb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                // Query to fetch data from the out_of_stock_list table
                $query = "SELECT * FROM out_of_stock_list";
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
                                ...
                                <td
                                    style="vertical-align: middle; color: <?php echo getStatusColor($row['product_stock_name'], $row['expiry_date']); ?>;">
                                    <?php
                                    $expiryDate = new DateTime($row['expiry_date'] . ' ');

                                    // Add one day if the product is in the expired_list table
                                    if (getStatusColor($row['product_stock_name'], $row['expiry_date']) == 'red') {
                                    ...
                                    echo '<span style="color: green;">' . $formattedDate . '</span>';

                                    // Add space
                                    echo ' ';

                                    // Add Font Awesome icons based on expiration status
                                    $statusColor = getStatusColor($row['product_stock_name'], $row['expiry_date']);
    ...
    <script>
        $(document).ready(function () {
            $('#dataTable').DataTable({
                ...
                "columnDefs": [
                    { "orderable": false, "targets": [1, 3, 5, 4, 6, 7,8,9] } // Enable sorting for SKU, Quantity, Price, and Expiry Date columns
                ]
            });
        });
    </script>